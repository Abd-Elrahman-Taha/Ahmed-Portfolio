...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg, rgba(163, 230, 53, 0.15) 0%, rgba(56, 189, 248, 0.2) 100%)';
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  const cardStyle = useMemo<React.CSSProperties>(
    () => ({
      ...
      ['--behind-glow-color' as string]: behindGlowColor ?? 'rgba(163, 230, 53, 0.5)',
      ['--behind-glow-size' as string]: behindGlowSize ?? '50%'
    }),
